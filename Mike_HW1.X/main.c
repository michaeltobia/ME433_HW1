...
// DEVCFG0
#pragma config DEBUG = 00 // no debugging
...
#pragma config FPLLIDIV = 001 //(2x: 8->4) divide input clock to be in range 4-5MHz
#pragma config FPLLMUL = 111 // (24x: 4->96) multiply clock after FPLLIDIV
#pragma config FPLLODIV = 001 // (2: 96->48) divide clock after FPLLMUL to get 48MHz
#pragma config UPLLIDIV = 001 // (2: 8->4, 4*12->48) divider for the 8MHz input clock, then multiplied by 12 to get 48MHz for USB
#pragma config UPLLEN = 0 // USB clock on

// DEVCFG3
#pragma config USERID = 1010101010101010 // some 16bit userid, doesn't matter what
